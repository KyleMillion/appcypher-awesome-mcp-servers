...
- <img src="https://api.iconify.design/mdi:chart-line.svg?color=%2322c55e" height="14"/> [YIELD INTELLIGENCE](https://github.com/thebrierfox/intuitek-ace) - Passive income portfolio analysis: scans US Treasuries, dividend ETFs, REITs, and preferred stocks; optimizes allocation toward a target monthly income goal. Hosted endpoint: `https://api.intuitek.ai/yield/mcp`
